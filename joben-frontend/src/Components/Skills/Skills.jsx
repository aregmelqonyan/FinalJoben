    ...
    useEffect(() => {
        const fetchSkills = async () => {
            try {
                ...
                if (!user_id){
                const response = await axios.get('https://api.joben.am/skills', {
                  headers: {
              ...
              try{
                if(!user_id){
                const response = await axios.get('https://api.joben.am/companyskills/', {
                  headers: {
                      'Authorization': `Bearer ${token}`
                  }
              });
                ...
                try{
                    const response = await axios.get(`https://api.joben.am/companyskills/${user_id}`);
                    setSkills(response.data);
                }
                catch(error){
